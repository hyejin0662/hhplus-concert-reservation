package com.concert_reservation.common.logtrace.impl;
...
import com.concert_reservation.common.logtrace.LogTracer;
import com.concert_reservation.common.logtrace.TraceStatus;
...
public class GlobalTraceHandler {
	...
	@Pointcut("execution(* com.concert_reservation.api..*(..)) ")
	public void all() {
	}
